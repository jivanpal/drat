...
void print_apfs_superblock(apfs_superblock_t* apsb) {
    ...
    printf("Index within container volume array:    %"PRIu32"\n",  apsb->apfs_fs_index);
    printf("\n");
